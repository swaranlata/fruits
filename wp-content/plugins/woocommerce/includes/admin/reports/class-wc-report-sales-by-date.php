			...
			jQuery(function(){
				...
				jQuery('.highlight_series').hover(
					function() {
                        ...
                        jQuery.each(main_chart.getData()[0].data, function(i, el){
                          var o =main_chart.pointOffset({x: el[0], y: el[1]});
                         jQuery('<div class="data-point-label">' + el[1] + '</div>').css( {
                            position: 'absolute',
                            left: o.left + 4,
                            top: o.top - 43,
                            display: 'none'
                          }).appendTo(main_chart.getPlaceholder()).fadeIn('slow');
                        });
                        jQuery.each(main_chart.getData()[1].data, function(i, el){
                          var o =main_chart.pointOffset({x: el[0], y: el[1]});
                         jQuery('<div class="data-point-label">' + el[1] + '</div>').css( {
                            position: 'absolute',
                            left: o.left + 4,
