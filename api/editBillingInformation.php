...
$editBillingAddress=editBillingAddress($data,'app');
if(!empty($editBillingAddress)){
   response(1,getTextByLang('Billing address updated successfully.',$data['lang']),getTextByLang('No Error Found.',$data['lang']));   
}else{
